...
namespace Inventory {
    ...
    {
        [Header("Settings")] public PlayerProperties playerProperties;
        ...
        [Header("GUI References")] public Transform slotParent;
        ...
        [Header("GUI References/Detail View")] public Image iconLarge;
        ...
        [Header("GUI References/Info Bar")] public TextMeshProUGUI slotText;
        ...
        public void RefreshDisplay()
        {
            ...
            weightText.gameObject.SetActive(playerProperties
                .GetWeightCapacityEnabled()); //Only show texts if type capacity is enabled
        }
