...
namespace Quest
{
    public class QuestRepository: MonoBehaviour
    {
        ...
        public global::Quest.Quest GiveQuest(int questId)
        {
            ...
            if(questId == 21)
            {
                ...
                return new global::Quest.Quest(questId, "TestQuest1", "In Progress", firstStage, firstStage, false);
            }
            else if(questId == 22)
            {
                QuestStage firstStage = GiveStage(6);
                return new global::Quest.Quest(questId, "TestQuest2", "In Progress", firstStage, firstStage, false);
            }
            else if(questId == 23)
            {
                QuestStage firstStage = GiveStage(7);
                return new global::Quest.Quest(questId, "TestQuest3", "In Progress", firstStage, firstStage, false);
            }
            else
            {
                QuestStage firstStage = GiveStage(8);
                return new global::Quest.Quest(questId, "Generic Test Quest", "In Progress", firstStage, firstStage, false);
            }
